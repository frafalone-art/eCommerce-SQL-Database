...
This is a portfolio project meant to demonstrate schema design and query writing — not a production-ready e-commerce backend, more meant as a starting point.
